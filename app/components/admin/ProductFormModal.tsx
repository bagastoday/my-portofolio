...
export default function ProductTable({ products, onAdd, onEdit, onDelete }: any) {
  ...
  return (
    <section className="bg-white rounded-[2.5rem] border border-black/5 shadow-[0_20px_60px_-25px_rgba(0,0,0,0.2)] overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full md:w-64 bg-[#F7F7F2] rounded-full pl-11 pr-5 py-4 text-xs font-sans outline-none border border-black/5"
            />
          </div>

          <button
            onClick={onAdd}
            className="bg-black text-white px-6 py-4 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-[#7D8471] transition-all"
          >
            <Plus size={15} />
            Add Product
          </button>
        ...
        <table className="w-full min-w-[850px] text-left">
          ...
          <tbody>
            {filteredProducts.map((item: any) => (
              <tr
                key={item.id}
                className="border-t border-black/5 hover:bg-[#FAFAF8] transition-colors"
              >
                ...
                <td className="px-8 py-5 text-xs font-sans font-bold">
                ...
                <td className="px-8 py-5">
                  <div className="flex justify-end gap-2">
                    <button className="w-9 h-9 rounded-full bg-gray-50 flex items-center justify-center hover:bg-black hover:text-white transition-all">
                      <Eye size={14} />
                    </button>
